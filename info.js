...
document.querySelector('.ri-search-line').addEventListener('click', async () => {
  ...
  document.querySelector('.temp').innerHTML = ((weatherData.current_observation.condition.temperature - 32) * 5 / 9) + ` <sup> C</sup>`;
